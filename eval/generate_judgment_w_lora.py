...
def main(args):
    ...
    lora_params = LoRARequest("sql-lora", 1, args.lora_path)
    ...
    outputs = llm.generate(ps, sampling_params=sampling_params, lora_request=lora_params)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filename', type=str, default="mllm-judge-private-new/Flex-VL-32B-LoRA",
                        help="directory for checkpoint")
    parser.add_argument('--lora_path', type=str, default="sungnyun/Flex-VL-32B-LoRA",
                        help="directory for checkpoint")
