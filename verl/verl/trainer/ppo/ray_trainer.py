    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                print(time.strftime('%y%m%d - %X'), f"! ==== Global step {self.global_steps}, epoch {epoch}")
                ...
                with marked_timer("step", timing_raw):
                    print(time.strftime('%y%m%d - %X'), "[1] Generate a batch") 
                    ...
                    print(time.strftime('%y%m%d - %X'), "[2] compute reward model score") 
                    ...
                    print(time.strftime('%y%m%d - %X'), "[3] compute log_probs") 
                    ...
                    print(time.strftime('%y%m%d - %X'), "[4] compute values") 
                    ...
                    print(time.strftime('%y%m%d - %X'), "[5] update critic") 
                    ...
                    print(time.strftime('%y%m%d - %X'), "[6] update actor")
                    ...
                    print(time.strftime('%y%m%d - %X'), "[7] Log rollout generations")
                ...
                print(time.strftime('%y%m%d - %X'), "[8] Validation") 
